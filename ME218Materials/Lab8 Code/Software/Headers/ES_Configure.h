...
#define SERV_0_HEADER "DCMotorSM.h"
// the name of the Init function
#define SERV_0_INIT InitDCMotorSM
// the name of the run function
#define SERV_0_RUN RunDCMotorSM
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "ADCService.h"
// the name of the Init function
#define SERV_1_INIT InitADCService
// the name of the run function
#define SERV_1_RUN RunADCService
// How big should this services Queue be?
...
#define EVENT_CHECK_LIST CheckNewCommand, CheckTapeSensor
...
#define TIMER14_RESP_FUNC PostDCMotorSM
#define TIMER15_RESP_FUNC PostDCMotorSM
