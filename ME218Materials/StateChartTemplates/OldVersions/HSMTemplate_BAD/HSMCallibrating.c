...
static CallibratingState_t CurrentState;
...
****************************************************************************/
ES_Event RunCallibratingSM( ES_Event CurrentEvent )
{
   unsigned char MakeTransition = False;/* are we making a state transition? */
   CallibratingState_t NextState = CurrentState;
   ...
   switch ( CurrentState )
   {
    ...
    if (MakeTransition == True)
    {
       ...
       RunCallibratingSM(CurrentEvent);
        
       CurrentState = NextState; //Modify state variable
       
       //   Execute entry function for new state
       // this defaults to ES_ENTRY
       RunCallibratingSM(EntryEventKind);
     }
     return(CurrentEvent);
}
/****************************************************************************
...
****************************************************************************/
void StartCallibratingSM ( ES_Event CurrentEvent )
{
...
/****************************************************************************
 ...
 Returns
     CallibratingState_t The current state of the Callibrating state machine

 Description
     returns the current state of the Callibrating state machine
 Notes

 Author
     J. Edward Carryer, 2/11/05, 10:38AM
****************************************************************************/
CallibratingState_t QueryCallibratingSM ( void )
{
   return(CurrentState);
}
